...
public class PermissionsCheckActivity extends AppCompatActivity
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == PERMISSON_REQUESTCODE) {
            if (!verifyPermissions(paramArrayOfInt)) {
                ...
                MyToast.showToast("权限请求成功！");
                new PermissionCheckInterface() {
                    @Override
                    public void permissionSuccesed() {

                    }

                    @Override
                    public void permissionFailer() {
    ...
    public interface PermissionCheckInterface {
        //成功
        void permissionSuccesed();

        //失败
        void permissionFailer();
